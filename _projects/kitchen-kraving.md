...
caption: Interactive VR cooking game with immersive hand tracking
description: >
  Fast-paced kitchen-themed VR game developed at Carnegie Mellon ETC and published on the Oculus Store
date: '01-01-2015'
image: 
...
## Description
Kitchen Kraving is a Virtual Reality game in a kitchen setting where the users have to make food while stealing food to eat without being caught by the boss, who randomly checks in on the user. The game was first developed at Carnegie Mellon ETC with a group of artists, programmers, and sound designers. It was later published on the Oculus Store.
